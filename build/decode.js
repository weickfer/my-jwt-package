...
function decodeToken(token) {
  ...
  var headerJson = (0, _base.base64urlDecode)(header);
  var payloadJson = (0, _base.base64urlDecode)(payload);
  return {
    header: (0, _object.safeJsonParse)(headerJson),
    payload: (0, _object.safeJsonParse)(payloadJson),
    signature: signature
  };
}